...
public class Usuario {
    ...
    private String rol;          // Administrador | Cajero | Inventario | Delivery
    ...
    public boolean esInventario()    { return "Inventario".equals(rol);    }
    public boolean esDelivery()      { return "Delivery".equals(rol);      }
